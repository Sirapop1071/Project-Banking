...
public class AddFixedDeAccount extends JFrame {
    private JPanel contentPane;
    private JTextField textField;
    private JTextField textField_1;
    private JTextField textField_2;

    public AddFixedDeAccount() {
        ...
        JLabel lblAddCurrentAccount = new JLabel("Add FixedDeposit Account ");
        ...
        JLabel lblMaximumWithdrawLimit = new JLabel("How many months 3-6-12: ");
        ...
        btnAdd.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                int cm = Integer.parseInt(textField_2.getText());

                if (bal < 1000) {
                    JOptionPane.showMessageDialog(getComponent(0), "Minimum Limit 1000", "Warning", 0);
                    ...
                    if (name == null || bal <= 0 || cm <= 0) {
                        ...
                        if (ch == 0) {
                            int index = 0;
                            try {
                                index = FileIO.bank.addAccount(name, bal, cm);
                            } catch (Exception e1) {
